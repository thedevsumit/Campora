    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800 px-4 py-4 flex items-center gap-4 sticky top-16 z-30">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-slate-900 dark:text-white">Private Chat</h1>
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          {messages.map((m, i) => {
            ...
            return (
              ...
              >
                {!me && <Avatar src={m.sender.profilePic} name={m.sender.fullName} />}
                ...
                {me && <Avatar src={authUser.profilePic} name={authUser.fullName} />}
              </div>
            );
          })}
          <div ref={bottomRef} />
      ...
      <div className="bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 px-4 py-4">
        <div className="max-w-3xl mx-auto flex gap-3">
          ...
          />
          <Button onClick={handleSend} disabled={!text.trim()} className="px-6 shadow-lg shadow-primary-500/30">
