        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm text-green-700 font-medium hover:text-green-800">
                Forgot Password?
              </a>
            </div>
            ...
            <button
              ...
              className="w-full bg-green-700 hover:bg-green-800 text-white font-medium py-3 rounded-lg transition-colors duration-200"
            >
              Sign In
            </button>
            ...
            <div className="text-center mt-6">
              <span className="text-sm text-gray-600">
                ...
                <a href="#" className="text-green-700 font-medium hover:text-green-800">
                  Sign Up
                </a>
              </span>
            </div>
