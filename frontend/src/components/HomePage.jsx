  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          className="absolute bottom-10 right-20 w-96 h-96 bg-secondary-400/20 rounded-full blur-3xl animate-float"
          style={{ animationDelay: "2s" }}
        />
        <div className="absolute top-40 right-40 w-32 h-32 border border-white/10 rounded-full animate-pulse" />
        <div
          className="absolute bottom-40 left-40 w-20 h-20 border border-white/10 rounded-full animate-pulse"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg md:text-xl text-primary-100 max-w-xl mx-auto lg:mx-0 animate-fade-in-up stagger-1">
                  Join clubs, attend events, book resources, and connect with
                  students across your campus community.
                </p>
              </div>
            ...
            <div className="hidden lg:flex justify-center animate-fade-in-up stagger-2">
              <svg
                viewBox="0 0 500 450"
                className="w-[500px] h-[450px] drop-shadow-2xl"
              ...
              >
                ...
                {/* Stars */}
                <path
                  d="M50 180 l3 6 7 1 -5 5 1 7 -6-3 -6 3 1-7 -5-5 7-1z"
                  fill="#fbbf24"
                />
                <path
                  d="M450 200 l2 5 6 1 -4 4 1 6 -5-3 -5 3 1-6 -4-4 6-1z"
                  fill="#fbbf24"
                />
                <path
                  d="M280 60 l2 4 5 1 -4 3 1 5 -4-2 -4 2 1-5 -4-3 5-1z"
                  fill="#fbbf24"
                />
          ...
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <p className="text-slate-500 text-base max-w-xl">
                From coding clubs to cultural societies, find the perfect
                community that matches your interests and passion. Each club is
                a gateway to new experiences and lifelong friendships.
              </p>
            </div>
            <Button
              variant="ghost"
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-sm text-slate-500 dark:text-slate-400 line-clamp-2 mb-4">
                    {club.description ||
                      "A vibrant campus community waiting for you to join."}
                  </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            <div>
              ...
              <p className="text-slate-500 text-base max-w-xl">
                Mark your calendar! These upcoming events bring together
                students across campus for unforgettable experiences —
                workshops, competitions, cultural nights, and so much more.
              </p>
            </div>
            <Button
              variant="ghost"
      ...
      <section className="py-20 bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-700 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-primary-100 mb-10 max-w-2xl mx-auto animate-fade-in-up stagger-1">
            Create an account to join clubs, attend events, book resources, and
