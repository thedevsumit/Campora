...
import {
  ...
  Trophy, Zap, Heart, Code, CheckCircle, Loader2
} from "lucide-react";
...
export default function EventsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-2 mb-6 animate-fade-in">
                ...
                <span className="text-amber-200 font-semibold text-sm uppercase tracking-wider">Campus Events</span>
              </div>
              ...
              <p className="text-primary-100 text-lg md:text-xl mb-8 animate-fade-in-up stagger-1 max-w-xl leading-relaxed">
                From hackathons to cultural nights, there's always something exciting happening on campus. Find events that match your passion, learn from experts, and create unforgettable memories with fellow students.
              </p>
            ...
            <div className="hidden lg:flex justify-center animate-fade-in-up stagger-2">
              <svg viewBox="0 0 400 350" className="w-[400px] h-[350px]" xmlns="http://www.w3.org/2000/svg">
                {/* Background circles */}
                <circle cx="200" cy="175" r="140" fill="url(#heroGrad)" opacity="0.1" />
                <circle cx="200" cy="175" r="100" fill="url(#heroGrad)" opacity="0.05" />
                ...
                {/* Large Calendar Card */}
                <rect x="80" y="60" width="240" height="200" rx="20" fill="white" opacity="0.15" />
                <rect x="90" y="70" width="220" height="180" rx="16" fill="white" opacity="0.2" />
                <rect x="100" y="80" width="200" height="160" rx="12" fill="white" opacity="0.95" />

                {/* Calendar Header */}
                <rect x="100" y="80" width="200" height="40" rx="12" fill="url(#calGrad)" />
                ...
                {/* Calendar Body */}
                <rect x="115" y="135" width="30" height="25" rx="4" fill="#7c3aed" opacity="0.3" />
                <rect x="155" y="135" width="30" height="25" rx="4" fill="#7c3aed" opacity="0.6" />
                <rect x="195" y="135" width="30" height="25" rx="4" fill="#7c3aed" opacity="0.3" />
                <rect x="235" y="135" width="30" height="25" rx="4" fill="#059669" opacity="0.5" />

                <rect x="115" y="170" width="30" height="25" rx="4" fill="#059669" opacity="0.4" />
                <rect x="155" y="170" width="30" height="25" rx="4" fill="#7c3aed" opacity="0.8" />
                <rect x="195" y="170" width="30" height="25" rx="4" fill="#059669" opacity="0.3" />
                <rect x="235" y="170" width="30" height="25" rx="4" fill="#7c3aed" opacity="0.3" />

                <rect x="115" y="205" width="30" height="25" rx="4" fill="#7c3aed" opacity="0.3" />
                <rect x="155" y="205" width="30" height="25" rx="4" fill="#059669" opacity="0.4" />
                <rect x="195" y="205" width="30" height="25" rx="4" fill="#7c3aed" opacity="0.3" />
                <rect x="235" y="205" width="30" height="25" rx="4" fill="#fbbf24" opacity="0.8" />

                {/* Stars */}
                <path d="M50 150 l2 4 5 1 -4 3 1 5 -4-2 -4 2 1-5 -4-3 5-1z" fill="#fbbf24" />
                <path d="M350 120 l2 4 5 1 -4 3 1 5 -4-2 -4 2 1-5 -4-3 5-1z" fill="#fbbf24" />
                <path d="M60 250 l1.5 3 4 0.5 -3 2.5 0.5 4 -3-1.5 -3 1.5 0.5-4 -3-2.5 4-0.5z" fill="#fcd34d" />
                <path d="M340 220 l1.5 3 4 0.5 -3 2.5 0.5 4 -3-1.5 -3 1.5 0.5-4 -3-2.5 4-0.5z" fill="#fcd34d" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white mb-4">
            Why{" "}
            <span style={{ background: 'linear-gradient(to right, #fbbf24, #f59e0b)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Attend Events?</span>
          </h2>
          <p className="text-slate-500 max-w-2xl mx-auto text-lg leading-relaxed">
            Campus events are more than just activities — they're opportunities to learn, grow, and connect. Here's what you gain by participating.
          </p>
        </div>
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-1">
              {searchQuery ? `Showing results for "${searchQuery}"` : "Explore and find your next adventure"}
            </p>
          </div>
                ...
                >
                  ...
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4 flex gap-2">
                      <Badge variant="primary" className="backdrop-blur-xl bg-white/20 text-white border border-white/30 font-medium">
                        {event.category || "General"}
                      </Badge>
                    </div>
                    {isFull && (
                      <div className="absolute top-4 right-4">
                        <Badge variant="danger" className="bg-white/20 backdrop-blur-xl border border-white/30 font-medium">
                          Event Full
                        </Badge>
                      </div>
                    )}
                      ...
                      <div className="flex items-center gap-2 bg-gradient-to-br from-primary-600 to-primary-700 rounded-xl px-4 py-3 shadow-lg">
                        ...
                        {event.time && (
                          <div className="border-l border-white/20 pl-2 ml-1">
                            <p className="text-xs text-primary-200">{event.time}</p>
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 line-clamp-2 mb-5 leading-relaxed">
                      {event.description || "An exciting event you don't want to miss. Join us for an unforgettable experience!"}
                    </p>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-slate-800">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-slate-600 dark:text-slate-400 font-medium">{event.club?.clubName || "Campus"}</span>
                      </div>
                      <Button
                        size="sm"
        ...
        <div className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-700 rounded-3xl p-10 text-white text-center overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-primary-100 text-lg max-w-xl mx-auto mb-6 leading-relaxed">
              Clubs can create and manage their own events. Reach out to your club admin or check the resource booking page to get started!
            </p>
      ...
      {/* Register Modal */}
      <Modal isOpen={showRegisterModal} onClose={() => { setShowRegisterModal(false); setShowConfirmation(false); }} title={showConfirmation ? "Confirm Registration" : `Register for ${selectedEvent?.title}`} size="md">
        {!showConfirmation ? (
          /* Step 1: Form Entry */
          <div className="space-y-5">
            <div className="bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-primary-900/20 dark:to-secondary-900/20 rounded-2xl p-4 border border-primary-100 dark:border-primary-800">
              <p className="text-sm text-slate-600 dark:text-slate-400 mb-2">Registering for</p>
              <p className="font-bold text-slate-900 dark:text-white text-lg">{selectedEvent?.title}</p>
              <div className="flex items-center gap-3 mt-2 text-sm text-slate-500">
                <Calendar className="w-4 h-4" />
                <span>{selectedEvent?.date ? new Date(selectedEvent.date).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" }) : "Date TBA"}</span>
                {selectedEvent?.venue && (
                  <>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <Button onClick={handleRegistrationSubmit} disabled={!registrationData.name || !registrationData.email || !registrationData.year}>
                Review Registration
                <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
            </div>
          ...
          <div className="space-y-5">
            <div className="bg-gradient-to-br from-secondary-50 to-primary-50 dark:from-secondary-900/20 dark:to-primary-900/20 rounded-2xl p-5 border border-secondary-100 dark:border-secondary-800 text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Confirm Your Registration</h3>
              <p className="text-slate-500 text-sm">Please review your details before confirming</p>
            </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-800 rounded-2xl p-5 space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-slate-900 dark:text-white">{registrationData.name}</p>
                  <p className="text-sm text-slate-500">{registrationData.email}</p>
                  {registrationData.phone && <p className="text-sm text-slate-500">{registrationData.phone}</p>}
                </div>
              </div>
              <div className="border-t border-slate-200 dark:border-slate-700 pt-3">
                ...
                <div className="flex items-center gap-2 text-sm mt-1">
                  ...
                  <span className="font-medium text-slate-900 dark:text-white">{registrationData.year}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between gap-3 pt-4 border-t border-slate-100 dark:border-slate-800">
              ...
              <Button onClick={confirmRegistration} isLoading={isRegistering} className="bg-gradient-to-r from-secondary-500 to-secondary-600 hover:from-secondary-600 hover:to-secondary-700">
