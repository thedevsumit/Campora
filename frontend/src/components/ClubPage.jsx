...
import { Search, Plus, Users, Sparkles, Folders, TrendingUp, Zap, Globe } from "lucide-react";
...
const ClubsPage = () => {
  ...
  const totalMembers = clubs.reduce((sum, club) => sum + (club.memberCount || club.members?.length || 0), 0);
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              ...
              <p className="text-primary-100 text-lg md:text-xl animate-fade-in-up stagger-1 max-w-xl">
                Find your community and make lasting connections. Join clubs
                that match your interests and passion.
              </p>
              <div className="flex items-center gap-8 mt-6 justify-center md:justify-start animate-fade-in-up stagger-2">
            ...
            <div className="flex flex-col items-center gap-4 animate-fade-in-up stagger-2">
              <Button
                ...
                variant="outline"
                className="border-white/80 text-white w-45 hover:bg-white/20 hover:border-white"
              >
                <Plus className="w-5 h-5 mr-2" />
                Create Club
              </Button>
              <p className="text-white/70 text-sm">Start your own community</p>
            </div>
          </div>
        </div>

        {/* Wave */}
        <div className="absolute bottom-0 top-100 left-0 right-0">
          <svg
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-10">
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-primary-500/5 p-3 border border-slate-200/50 dark:border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-100 dark:border-slate-800 shadow-sm">
            ...
            <p className="text-sm text-slate-500">
              Workshops, hackathons, and hands-on sessions with industry
              experts.
            </p>
          </div>
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-100 dark:border-slate-800 shadow-sm">
            <div className="w-12 h-12 rounded-xl bg-secondary-100 dark:bg-secondary-900/30 flex items-center justify-center mb-3">
            ...
            <p className="text-sm text-slate-500">
              Network with like-minded students and make lifelong friends.
            </p>
          </div>
          <div className="bg-white dark:bg-slate-900 rounded-2xl p-5 border border-slate-100 dark:border-slate-800 shadow-sm">
            ...
            <p className="text-sm text-slate-500">
              Participate in events, competitions, and campus activities.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="text-center py-24">
            ...
            <p className="text-slate-500 mb-8 max-w-md mx-auto">
              {searchQuery
                ...
                : "Be the first to create a club and inspire your campus!"}
            </p>
            {!searchQuery && (
