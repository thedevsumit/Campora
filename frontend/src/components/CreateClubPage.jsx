...
const perks = [
  {
    ...
    desc: "Connect with students who share your interests and passion",
  },
  {
    icon: Calendar,
    title: "Host Events",
    desc: "Organize workshops, hackathons, meetups, and campus activities",
  },
  {
    icon: Trophy,
    title: "Compete & Win",
    desc: "Participate in inter-college events and competitions",
  },
  {
    icon: Heart,
    title: "Make Friends",
    desc: "Find your tribe and create lifelong memories together",
  },
];
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-700 text-white pt-16 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-primary-100 text-xl max-w-2xl mx-auto animate-fade-in-up stagger-1 leading-relaxed">
              Every great campus movement starts with a single step. Define your
              vision, gather your community, and watch your club grow into
        ...
        <div className="absolute bottom-[-10px] left-0 right-0">
          ...
          >
            <path
              d="M0 30C120 20 240 10 360 15C480 20 600 30 720 35C840 40 960 40 1080 35C1200 30 1320 20 1380 15L1440 10V60H1380C1320 60 1200 60 1080 60C960 60 840 60 720 60C600 60 480 60 360 60C240 60 120 60 60 60H0V30Z"
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {perks.map((perk, i) => (
            <div
              key={i}
              className="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div
                className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${i === 0 ? "from-primary-500 to-primary-600" : i === 1 ? "from-secondary-500 to-secondary-600" : i === 2 ? "from-amber-500 to-amber-600" : "from-rose-500 to-rose-600"} flex items-center justify-center mb-4 shadow-lg`}
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-primary-200 text-sm mt-1">
                      Tell us about your club vision
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="relative flex-shrink-0">
                    {/* Drag & Drop Area */}
                    <div
                      className={`w-32 h-32 rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-800 border-2 border-dashed ${isDragging ? "border-primary-500 bg-primary-50/20 dark:bg-primary-900/20" : "border-slate-300 dark:border-slate-600"} flex items-center justify-center shadow-inner transition-colors`}
                      onDrop={handleDrop}
                    ...
                    />
                    <label
                      htmlFor="club-icon-input"
                      className="cursor-pointer block mt-2 text-center"
                    >
                      <p className="text-xs text-slate-500 m-t-3">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    >
                      <option value="">
                        Choose the best category for your club
                      </option>
                      {categories.map((cat) => (
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-slate-400">
                    Minimum 50 characters. Be creative and specific!
                  </p>
                </div>
            ...
            <div className="bg-gradient-to-br from-primary-600 via-primary-700 to-secondary-700 rounded-3xl shadow-xl p-6 text-white sticky top-24">
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-4 p-4 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-primary-100 text-sm leading-relaxed">
                      Keep it short, unique, and easy to remember. Avoid generic
                      names that could describe any club.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/10">
                  ...
                  <div>
                    <p className="font-bold text-lg mb-1">
                      Write an Inspiring Description
                    </p>
                    <p className="text-primary-100 text-sm leading-relaxed">
                      Share your vision, goals, and what makes your club
                      special. Let potential members feel excited to join.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-primary-100 text-sm leading-relaxed">
                      This helps students find your club when searching. Be
                      honest about which category fits best.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-white/10 backdrop-blur-xl rounded-2xl border border-white/10">
                  ...
                  <div>
                    ...
                    <p className="text-primary-100 text-sm leading-relaxed">
                      Nothing attracts members like exciting upcoming events.
                      Think about what your first meetup will be!
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-white/20">
                <p className="text-primary-100 text-sm text-center leading-relaxed">
                  Your club will be reviewed by an admin and visible to all
                  students on campus once approved. Start building your
                  community today!
                </p>
              </div>
            </div>
